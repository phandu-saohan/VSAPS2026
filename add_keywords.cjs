...
async function run() {
  ...
  try {
    await client.query('ALTER TABLE public.speakers ADD COLUMN keywords TEXT');
    console.log('Added keywords column to speakers');
  } catch (e) {
    console.log('Error adding keywords to speakers: ' + e.message);
  }
